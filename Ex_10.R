...
# show bar plot of means of four populations, store as plot1
...
plot1 <- ggplot(data = mean_obs, aes( x = region, y=mean)) +
  geom_col() +
  theme_bw() +
  xlab("Region") +
...
# Do the bar and scatter plots tell you different stories? Why? 
  ...
  # plot shows the exact mean of the data, not taking into account high or low 
  # clusters of data, while the scatter plot shows the range of observations
  # for each region, with the dark clusters indicating high concentrations of data. 
